...
def test_app():
    ...
    app.button[2].click().run()  # bouton page Prédiction, en cliquant dessus cela lance aussi le test pour la verification de la presence du modele dans le dossier modele
