...
def main():
    ...
    subprocess.run(["python", "-m", "FightPredix_scraping.scraping.lib_join_ufc_tapology"], shell= True)
    ...
    for file_path in ["data/Data_ufc_fighters.csv", "data/Data_jointes_ufc_tapology.csv", "data/data_tapology.csv", "data/clean_tapology.csv"]:
